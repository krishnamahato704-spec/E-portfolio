...
export const RESEARCH_STAGES: ResearchStage[] = [
  {
    ...
    evidenceDoc: assetUrl('assets/democracy-lesson-plan.pdf'),
  ...
  },
  {
    ...
    evidenceDoc: assetUrl('assets/certificate-3.webp'),
  ...
  },
  {
    ...
    evidenceDoc: assetUrl('assets/democracy-plan-preview.webp'),
  ...
  },
  {
    ...
    evidenceDoc: assetUrl('assets/krishna-mahato-resume.pdf'),
