...
export function TlmExhibition3D({
  ...
  useFrame((_, delta) => {
    ...
    if (spotlightRef.current) {
      let targetX = 5.2;
      let targetZ = -2.2;
      if (hoveredProjectId === 'tlm-mock-election') {
        targetX = 6.4;
        targetZ = -1.8;
      } else if (hoveredProjectId === 'tlm-election-invitation') {
        targetX = 4.4;
        targetZ = -2.6;
      } else if (hoveredProjectId === 'tlm-election-guide') {
        targetX = 5.8;
        targetZ = -2.8;
