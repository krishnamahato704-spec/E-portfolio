...
import { CertificateItem } from '../data/galleryData';
...
export function CertificatesGallery({
  ...
  const CERTIFICATES_DATA = certificates(usePortfolioContent());
  return (
        ...
        <header className="certificates-header">
          <div className="certificates-meta-bar">
            ...
            <span className="certificates-count-pill">
              {CERTIFICATES_DATA.length} records · Certificates &amp; supplied badge
            </span>
          </div>
