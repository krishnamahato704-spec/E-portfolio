...
const categories={experiences:['Teaching','Observation'],certificates:['Academic','Teaching','Professional learning','Presentation'],resources:['Lesson plan','Teaching material','Assessment','Presentation']};
